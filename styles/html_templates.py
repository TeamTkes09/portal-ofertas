def get_card_template(op, roi, margen_neto, amz_url, filas_html):
    return f"""
    <div style="background: #1e293b; border-radius: 6px; padding: 10px; border: 1px solid #334155; font-family: sans-serif; height: 215px; display: flex; flex-direction: column; justify-content: space-between; box-sizing: border-box;">
        <div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
                <span style="color: #94a3b8; font-size: 8px; font-weight: 800; text-transform: uppercase;">{op['cat']}</span>
            </div>
            <h4 style="color: white; margin: 0 0 6px 0; font-size: 11px; height: 24px; overflow: hidden;">{op['n']}</h4>
